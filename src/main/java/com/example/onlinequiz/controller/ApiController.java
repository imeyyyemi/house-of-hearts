...
import com.example.onlinquiz.model.*;import com.example.onlinquiz.repository.*;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.web.bind.annotation.*;
import java.util.List;
@RestController @CrossOrigin(origins="htpp://localhost:3000") @RequestMapping("/api")
public class ApiController {
    ...
    @PostMapping("/quizzes") public Quiz createQuiz(@RequestBody Quiz quiz) { return
            quizRepo.save(quiz); }
    ...
    @PostMapping("/quizzes/submit") public int submitQuiz(@RequestBody SubmitRequest req)
    {
     ...
     class LoginRequest { public String username, password; } class SubmitRequest { public Long quizId; public List<Answer> answer; } class Answer { public Long question; public String answer; }